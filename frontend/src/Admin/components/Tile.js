export function Tile({ image, model, plate, setEditTab }) {
    return <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center">
        <div style={{ backgroundColor: "#d4e6f1", maxWidth: "300px", minHeight: "300px", minWidth: "230px"}} className="card p-3 shadow-lg rounded-4">
            <div className="flex-grow-1 d-flex justify-content-center align-items-center">
                <img src={image} alt={model} className="img-fluid rounded" style={{ maxHeight: "200px", maxWidth: "200px" }} />
            </div>
